...
document.addEventListener("DOMContentLoaded", function () {
	...
	fetch("data.jsp")
		...
		.then(data => {
			...
			queryInput.addEventListener("keyup", function() { autoComplete(stockData); });
			queryInput.addEventListener("focus", function() { autoComplete(stockData); });
			queryInput.addEventListener("blur",  function() { hideAutoComplete(); });
...
/* 검색어 유사도 검사 */
function findClosestMatch(inputValue, stockData) {
